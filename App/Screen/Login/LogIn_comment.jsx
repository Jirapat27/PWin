...
export default function LogIn_comment() {
  ...
  const handleSignUpPress = () => {
    navigation.navigate('SignUpScreen_comment', { placeName: placeName });
  };
  ...
  const handleLoginPress = async () => {
    try {
      ...
      if (!email) {
        Alert.alert('เกิดข้อผิดพลาด', 'จำเป็นต้องใส่ ที่อยู่อีเมล');
        return;
      }
