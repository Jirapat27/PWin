...
const ChooseDestinationScreen = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.head}>
        <Text style={styles.title}>เลือกจุดหมายปลายทาง</Text>
      </View>
      ...
      <View style={styles.buttomContainer}>
        <TouchableOpacity style={styles.ConfirmButton.container} onPress={confirmDestination}>
          <Text style={styles.ConfirmButton.text}>ยืนยันจุดหมายปลายทาง</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
