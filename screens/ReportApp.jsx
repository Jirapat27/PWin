...
const ReportApp = ({ navigation, route }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: '',
    images: [],
    selectedCategory: 'ปัญหาภายในแอป',
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.head}>
        <Text style={styles.title}>รายงานปัญหาภายในแอป</Text>
      </View>
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.labeContainer}>
          ...
          <Text style={styles.sublabel}>(ปัญหาที่พบเจอ, สิ่งที่เกิดขึ้น)</Text>
        </View>
        <TextInput
        ...
        <View style={styles.labeContainer}>
          ...
          <Text style={styles.sublabel}>(ภาพหน้าจอขณะเกิดปัญหา)</Text>
        </View>
        <FlatList
          horizontal
