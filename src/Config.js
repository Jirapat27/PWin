...
import { getAuth, signOut } from 'firebase/auth'; // Remove getReactNativePersistence import
...
export { auth, db, firestore, databaseRef, onValue, storage, off, signOut }; // Remove uploadBytes, storageRef, getDownloadURL exports